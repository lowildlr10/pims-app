...
import { IconArrowRightDashed, IconCancel, IconDiscountCheckFilled, IconThumbDownFilled, IconThumbUpFilled } from '@tabler/icons-react';
    ...
    <>
      {status === 'draft' && (
        <Menu.Item 
          ...
          onClick={() => handleOpenActionModal && handleOpenActionModal(
            'submit_approval',
            'Submit for Approval',
